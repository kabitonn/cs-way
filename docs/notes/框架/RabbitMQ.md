...
![Exchange(交换器) 示意图](../../assets/cs-note/framework/message-queue/RabbitMQ-Exchange.png)
...
![Binding(绑定) 示意图](../../assets/cs-note/framework/message-queue/RabbitMQ-Binding.png)
...
![消息队列的运转过程](../../assets/cs-note/framework/message-queue/RabbitMQ-Broker.png)
...
![direct 类型交换器](../../assets/cs-note/framework/message-queue/RabbitMQ-direct.png)
...
![topic 类型交换器](../../assets/cs-note/framework/message-queue/RabbitMQ-topic.png)
